		...
		<div class="container">
			<div class="topbar-inner clearfix">
				<div class="topbar-left topbar widget-area clearfix">
					<?php if (!is_user_logged_in()) dynamic_sidebar('topbar-left'); else{?>
					<aside class="topbar-widget widget widget_text">
						<div class="textwidget"><div class="extract-element">
								<span class="topbar-text">Hello <?php echo $current_user->user_login; ?> | <a href="<?= get_home_url( $blog_id, $path, $scheme ); ?>/tracking-number/">Tracking Number</a> | <a href="<?= get_home_url( $blog_id, $path, $scheme ); ?>/my-account/">My account</a> | <a href="<?php echo wp_logout_url('$index.php'); ?>">Log Out</a></span>
						</div></div>
					</aside>
					 <?php }?>
				</div>
